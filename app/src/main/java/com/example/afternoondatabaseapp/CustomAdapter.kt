...
class CustomAdapter(var context: Context, var data:ArrayList<User>):BaseAdapter() {
    private class ViewHolder(row:View?){
        ...
        init {
            ...
            this.btnDelete =  row?.findViewById(R.id.mbtnDel) as Button
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        viewHolder.btnDelete.setOnClickListener {
            ...
            ref.removeValue().addOnCompleteListener {
                if (it.isSuccessful){
                    Toast.makeText(context, "User deleted succesfully", Toast.LENGTH_LONG).show()
        ...
        viewHolder.btnUpdate.setOnClickListener {
            var intent = Intent(context,activity_usersupdate::class.java)
